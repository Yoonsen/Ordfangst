...
with expcol:
    ...
    with st.expander(
        "Søkefilter"
    ):  # separate settings for word search and data viewing
        ...
        with factorcol:
            factor = st.number_input(
                ...
                help=(
                    "Tallet som skrives inn her legges til lengden på ordet, målt i antall tegn inkludert * og bokstaver. "
        ...
        with freqlimcol:
            freqlim = st.number_input(
                "Laveste frekvensverdi",
                min_value=1,
                value=10,
                help="Filtrer vekk ord med lavere frekvens enn dette",
            )
        ...
        with limcol:
            limit = st.number_input(
                ...
                min_value=5,
                value=1000,
                help="Antall ord som skal hentes ut.",
            )
        ...
        filnavn = st.text_input(
            ...
            f"ordfangst_{word.strip('*') if word else 'søkeord'}.xlsx",
        )
...
df = (
    ...
    .reset_index(names=["ord"])
    .rename(columns={"freq": "frekvens"})
)
        ...
        if chosen:
            ...
            with year_col:
                from_year, to_year = st.select_slider(
                    "Årstall", options=list(range(1800, 2025, 1)), value=(1800, 2024)
                )
